...
const ForgetPassword = () => {
    ...
    const handleSendEmail = async () => {
        ...
        try {
            await axios.post(`http://freshveg-backend.onrender.com/forgot-password`, { email });
    ...
    const handleVerifyOTP = async () => {
        ...
        try {
            ...
            await axios.post(`http://freshveg-backend.onrender.com/verify-otp`, { email, otp: code });
    ...
    const handleSetNewPassword = async () => {
        ...
        try {
            await axios.post(`http://freshveg-backend.onrender.com/reset-password`, {
                email,
                otp: otp.join(""),
                newPassword,
            });
